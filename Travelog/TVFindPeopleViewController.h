...
@interface TVFindPeopleViewController : UIViewController <TravelogFindPeopleCellDelegate, UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, UISearchBarDelegate>
{
}
